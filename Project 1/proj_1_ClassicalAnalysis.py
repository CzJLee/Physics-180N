...
q_0 = (- (m_earth + m_sun) / m_sun ) * np.array([152.1e9, 0])
p_0 = (- (m_earth + m_sun) / m_sun ) * np.array([0, 29.78e3*m_earth])

t, q, p = hamiltonian_solve(d_qH, d_pH, d = 2, t_0 = 0.0, q_0 = q_0, p_0 = p_0, h = 86400, N = 100, method = "Euler")
